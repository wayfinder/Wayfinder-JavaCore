   ...
   <head>
      ...
      <script type='text/javascript'><xsl:text disable-output-escaping='yes'><![CDATA[
         ...
         function loadFilter() {
            ...
            prioritiesBox[1] = new Option(" High prio bugs ", "1");
            prioritiesBox[2] = new Option(" High and medium prio bugs ", "2");
            prioritiesBox[3] = new Option(" High, medium and low prio bugs ", "3");
         }
	    ...
	    content += "<table><tr><th>Release</th><th>Date</th><th>High prio</th><th>medium prio</th><th>low prio</th><th>Experimental</th></tr>";
        ...
        function displayLevel4(list, id1, id2, id3) {
         ...
         function getPriorityLegend() {
            var content = "";
            content += "<h5><span class='b-1'>&nbsp;&nbsp;&nbsp;</span> High prio ";
            content += "<span class='b-2'>&nbsp;&nbsp;&nbsp;</span> Medium prio ";
            content += "<span class='b-3'>&nbsp;&nbsp;&nbsp;</span> Low prio ";
